    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      <div className='absolute top-0 left-0 w-full h-section-height  bg-gradient-to-b from-cyan-100/70'></div>
       ...
       <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='text-course-deatails-heading-large  font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>Kingshuk</span></p>
       ...
       : <img src={courseData.courseThumbnail} alt="" />
        ...
        <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium hover:bg-blue-700'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
        <div className='pt-6'>
          ...
          <ul className='ml-4 pt-2 text-sm md:text-base list-disc text-gray-500'>
            ...
            <li>Doubt solving by the best educators.</li>
