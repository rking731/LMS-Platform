...
import CourseRating from '../../components/student/Rating'
    ...
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36 '>
      {/*left column*/ }
        <div className='text-gray-800'>
          ...
          <div className='flex items-center space-x-3 gap-1 mt-10'>
            <span className='text-xl font-bold whitespace-nowrap'>Rate this Course:</span>
            {[...Array(5)].map((_, i)=>(
