    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          <div className='flex items-center gap-3 shadow-card border bg-white border-blue-500 p-4 w-56 rounded-md'>
          ...
          <div className='flex items-center gap-3 shadow-card border bg-white border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-500 '>Total <br /> Courses</p>
            </div>
          </div>
          <div className='flex items-center gap-3 shadow-card border bg-white border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-500 '>Total <br /> Earnings</p>
            </div>
          </div>
          </div>
